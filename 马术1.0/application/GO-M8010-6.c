...
//		SATURATE(motor_s->mode, 0,    7);
		...
		SATURATE(motor_s->Pos, -411774.0f,  411774.0f);   //rad/s
...
//    
//		SET_485_DIR1_UP();
//    HAL_UART_Transmit_IT(&huart1, (uint8_t *)pData, sizeof(pData->motor_send_data)); 
//		HAL_Delay(1);
//		SET_485_DIR1_DOWN();
//    HAL_UARTEx_ReceiveToIdle_IT(&huart1, (uint8_t *)rData, sizeof(rData->motor_recv_data));
//		HAL_Delay(1);
